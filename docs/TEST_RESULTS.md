...
| Public Cairo CI | Pass; checksum-pinned workflow run `33719265431` reproduced build, 42 tests, artifact hashes and Sierra class hash at `74327ae` |
...
| Current public source CI | Pass at `74327ae`: frozen/script-disabled install, lint, typecheck, 79 unit tests, build, per-action budget/release gates, 42 Cairo tests, artifact identity and Pages deployment |
