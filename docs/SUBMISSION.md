...
- Demo: https://tang-vu.github.io/veilzero/ (deployment run `33505627511` succeeded for `56e9211`; HTTP 200 and hardened envelope content verified unauthenticated on 2026-09-01)
- Video: pending
